export default {
  ...
  AE: {
    ...
    description:
      "1. Flights to the United Arab Emirates are suspended.- This does not apply to the following:- aircraft operated for the purpose of evacuation (this Safety Decision does not alleviate the need for obtaining necessary authorisation from UAE Ministry of Foreign Affairs and International Cooperation);- UAE registered aircraft that are out of base on 24 March 2020 23:59 Local Time will be allowed to return to base carrying only UAE nationals and operator\u2019s crewmembers;- over-flights. 2. All Evacuation flights must have PAX APP data and Crew APP data; all ferry flights must have crew APP data.",
  },
  AF: {
    updated_at: "2020-04-24",
    description:
      "Flights to Afghanistan are suspended.- This does not apply to repatriation flights that bring back nationals of Afghanistan.",
  },
  AG: {
    updated_at: "2020-04-23",
    description:
      " 1. Flights to Antigua and Barbuda are suspended.- This does not apply to flights with a special approval.2. Passengers must be quarantined for 14 days. - This does not apply to passengers arriving from the Dominican Rep. 3. Passengers arriving from the Dominican Rep. must undergo a 14 days quarantine before departure, and a 14 days quarantine upon arrival in Antigua and Barbuda. ",
  },
  AI: { updated_at: "2020-04-07", description: "Airports in Anguilla are closed. " },
  AL: {
    updated_at: "2020-04-29",
    description:
      " Flights to Albania are suspended.- This does not apply to flights operated by Air Albania (ZB) from/to Istanbul (IST).- This does not apply to repatriation and emergency flights. ",
  },
  AM: {
    updated_at: "2020-04-17",
    description:
      " 1. Passengers are not allowed to enter Armenia.- This does not apply to:- nationals and residents of Armenia;- immediate family members of nationals of Armenia;- diplomats and their immediate family members.2. Passengers who are allowed to enter Armenia are subject to a 14 day quarantine.",
  },
  AO: {
  ...
  AW: {
    ...
    description:
      " Passengers are not allowed to enter Aruba. - This does not apply to:- legal residents of Aruba with prior authorization;- special circumstances to non-resident passengers which are granted upon request . e.g. medical personnel;- medevac flights, humanitarian flights, transit/transfer flights with prior approval from the DCA Aruba.",
  },
  AZ: {
  ...
  BB: {
    updated_at: "2020-04-17",
    description:
      "Barbados (BGI) is closed. - This does not apply to Medevac flights, technical stops, and authorized flights, e.g. humanitarian aid.",
  },
  BD: {
  ...
  BI: { updated_at: "2020-04-21", description: "Flights to Burundi are suspended.</p><p>" },
  BJ: {
  ...
  BM: {
    updated_at: "2020-04-18",
    description:
      "Passengers are not allowed to enter Bermuda.- This does not apply to nationals and residents of Bermuda. - This does not apply to passengers with a written permission of the Quarantine Authority of Bermuda.",
  },
  BN: {
  ...
  BO: { updated_at: "2020-05-01", description: "Bolivia's borders are closed." },
  BQ: {
  ...
  BY: {
    ...
    description:
      "A completed awareness questionnaire must be presented upon arrival and passengers must self-isolate for 14 days.- This does not apply to passengers in transit. ",
  },
  BZ: { updated_at: "2020-04-21", description: " Airports in Belize are closed." },
  CA: {
  ...
  CD: {
    ...
    description:
      "1. Flights to Congo (Dem. Rep.) are suspended.- This does not apply to pre-approved repatriation flights.2. Passengers and airline crew must go through medical screening upon arrival and present a completed Health Sanitary Card provided by Health Authorities.",
  },
  CF: {
    updated_at: "2020-05-07",
    description:
  ...
  CG: { updated_at: "2020-03-26", description: "Airports in Congo are closed." },
  CH: {
  ...
  CM: { updated_at: "2020-04-15", description: "All international flights to Cameroon are suspended." },
  CN: {
    updated_at: "2020-05-11",
    description:
  ...
  CO: { updated_at: "2020-04-09", description: "Flights to Colombia are suspended." },
  CR: {
    updated_at: "2020-04-14",
    description:
  ...
  DJ: { updated_at: "2020-03-24", description: "Flights to Djibouti are suspended." },
  DK: {
    updated_at: "2020-05-20",
    description:
  ...
  DM: {
    updated_at: "2020-04-16",
    description:
      "1.Passengers are not allowed to enter Dominica.-This does not apply to nationals of Dominica who will be placed in a 14-day mandatory quarantine. 2.Airline crew is not allowed to disembark.",
  },
  DO: { updated_at: "2020-05-03", description: "Flights to Dominican Rep. are suspended.</p>" },
  DZ: { updated_at: "2020-04-17", description: "Flights to Algeria are suspended." },
  EC: { updated_at: "2020-05-20", description: " Flights to Ecuador are suspended." },
  EE: {
    updated_at: "2020-05-15",
    description:
  ...
  EG: {
    ...
    description:
      " Flights to Egypt are suspended.- This does not apply to:- aircraft in state of emergency;- the following flights with pre-authorization from the Egyptian Civil Aviation Authority: humanitarian flights, medevac, repatriation flights, technical landings and United Nations flights.",
  },
  ER: { updated_at: "2020-04-02", description: "Asmara (ASM) is closed." },
  ES: {
  ...
  FJ: {
    ...
    description:
      " 1. Passengers and airline crew are not allowed to enter Fiji. - This does not apply to nationals of Fiji.2. Nationals of Fiji must go into quarantine for a period of 14 days.",
  },
  FK: {
    updated_at: "2020-05-11",
    description:
      " Passengers are not allowed to enter Falkland Isl. (Malvinas).- This does not apply to:- returning residents, passengers with Falkland Isl. (Malvinas) status, passengers with a residence or work permit;- passengers traveling on official business for the Falkland Isl. (Malvinas)'s Government;- passengers with a permission to travel issued by the Falkland Isl. (Malvinas)\u2019s Government.",
  },
  FM: {
  ...
  GB: { updated_at: "2020-05-12", description: "No regulations related to Coronavirus (COVID-19) implemented." },
  GD: {
    updated_at: "2020-04-17",
    description:
  ...
  GF: {
    updated_at: "2020-05-06",
    description:
      ' 1. A completed International Travel Certificate must be presented prior to boarding and to Immigration upon arrival or when transiting French Guiana. The certificate must be obtained before departure via the French consular offices abroad or online at <a target="_blank" href="https://www.interieur.gouv.fr/">https://www.interieur.gouv.fr</a>.2. Passengers must go through a medical examination upon arrival and are subject to quarantine for a period of 14 days.- This does not apply to healthcare professionals related to Coronavirus (COVID-19).',
  },
  GH: {
    updated_at: "2020-05-02",
    description:
      "1. Flights to Ghana are suspended.- This does not apply to emergency flights, humanitarian flights, technical landing for refuel and medical evacuation flights.2. Airline crew will undergo mandatory quarantine during their rotation/rest period.",
  },
  GI: {
    updated_at: "2020-04-16",
    description:
  ...
  GL: { updated_at: "2020-04-24", description: "Please see Coronavirus (COVID-19) regulations for Denmark." },
  GM: { updated_at: "2020-04-22", description: "Flights to Gambia are suspended." },
  GN: {
    updated_at: "2020-05-14",
    description:
      " Guinea's borders are closed.- This does not apply to nationals of Guinea with an approval from the government and a medical certificate stating that the passenger is not affected by Coronavirus (COVID-19).",
  },
  GP: {
    updated_at: "2020-05-06",
    description:
  ...
  GQ: {
    updated_at: "2020-04-24",
    description:
      "Flights to Equatorial Guinea are suspended.- This does not apply to charter flights if they have a special permit obtained from the Civil Aviation.",
  },
  GR: {
    updated_at: "2020-05-15",
    description:
  ...
  GT: {
    updated_at: "2020-05-07",
    description:
      " Airports in Guatemala are closed. - This does not apply to humanitarian, military or ambulance flights.",
  },
  GU: {
    updated_at: "2020-03-30",
    description:
  ...
  GW: { updated_at: "2020-04-27", description: "Airports in Guinea-Bissau are closed." },
  GY: {
    updated_at: "2020-05-07",
    description:
      "Flights to Guyana are suspended.- This does not apply to:- Nationals and residents of Guyana.- Urgent health condition motive;- Professional trips which cannot be deferred as authorized;- Medevac flights;- Technical stops for fuel only and special authorized flights.",
  },
  HK: {
  ...
  HN: {
    updated_at: "2020-04-22",
    description:
      "Airports in Honduras are closed.- This does not apply to humanitarian flights with an authorization issued 24h before departure by the Secretariat of tourism or Secretariat for foreign relations and international cooperation of Honduras.",
  },
  HR: {
    updated_at: "2020-05-07",
    description:
  ...
  HT: {
    updated_at: "2020-04-14",
    description:
      " Flights to Port-au-Prince (PAP) and Cap-Haitien (CAP) are suspended. - This does not apply to emergency, humanitarian, medevac and government flights.",
  },
  HU: {
    updated_at: "2020-05-22",
    description:
      "Passengers are not allowed to enter Hungary- This does not apply to nationals of Hungary. - This does not apply to residents of Hungary who are nationals of an EEA Member State or Switzerland and who have a permanent residence card issued by Hungary.- This does not apply to nationals of Slovakia arriving directly from Slovakia if their stay in Hungary is not longer than 24 hours. - This does not apply to nationals of Austria arriving directly from Austria. They must have proof that they have been tested negative on Coronavirus (COVID-19) within 4 days before arrival. - This does not apply to nationals of Austria, Czechia, Germany, Japan, Korea (Rep.), Poland and Slovakia travelling on business. They must arrive directly from their home country. ",
  },
  ID: {
    updated_at: "2020-05-12",
    description:
  ...
  IE: {
    updated_at: "2020-05-19",
    description:
      "Passengers arriving in Ireland (Rep.) are required to self-quarantine for 14 days and complete a Public Health Passenger Locator Form.- This does not apply when arriving from Northern Ireland. - This does not apply to essential supply chain workers, for example, a pilot or a haulier.",
  },
  IL: {
    updated_at: "2020-05-22",
    description:
      "Passengers are not allowed to transit or enter Israel.- This does not apply to: - nationals and residents of Israel. - passengers with an entry approval issued by the Population and Immigration Authority of Israel.",
  },
  IN: {
    updated_at: "2020-05-22",
    description:
  ...
  IQ: {
    updated_at: "2020-04-24",
    description:
      "Flights to Iraq are suspended.- This does not apply to red cross, humanitarian, Medevac, repatriation, emergency and military flights.",
  },
  IR: {
    updated_at: "2020-05-22",
    description:
  ...
  JM: {
    updated_at: "2020-05-06",
    description:
      "1. Passengers are not allowed to enter Jamaica.- This does not apply to passengers with a Travel Authorization document issued by the government of Jamaica.2. Passengers with a Travel Authorization document issued by the government of Jamaica will be quarantined for 14 days. ",
  },
  JO: {
    updated_at: "2020-04-07",
    description:
      " Flights to Jordan are suspended.- This does not apply to:- emergency, humanitarian, medevac, repatriation, United Nations and state/diplomatic flights.- technical stops if crew and passengers do not disembark.",
  },
  JP: {
  ...
  KI: { updated_at: "2020-03-23", description: " Tarawa (TRW) is closed." },
  KM: { updated_at: "2020-03-23", description: " Flights to Comoros are suspended." },
  KN: { updated_at: "2020-04-12", description: "Airports in St. Kitts and Nevis are closed." },
  KP: {
    updated_at: "2020-02-06",
    description:
      " 1. Passengers traveling as tourists are not allowed to enter. 2. Passengers traveling on business or duty must spend 14 days in quarantine upon arrival.",
  },
  KR: {
    updated_at: "2020-05-20",
    description:
  ...
  KY: {
    updated_at: "2020-05-14",
    description:
      "Flights to Grand Cayman (GCM) are suspended.- This does not apply to emergency, repatriation and Medevac flights. They must obtain a prior approval from the Civil Aviation in Cayman Isl.",
  },
  KZ: {
    updated_at: "2020-05-06",
    description:
      " Airports are closed for international flights.- This does not apply to state, ferry, sanitary flights and technical landings for refuel.",
  },
  LA: {
    updated_at: "2020-05-20",
    description:
      "Flights to Lao People's Dem. Rep. are suspended.- This does not apply to air medevac, humanitarian, relief, diplomat and repatriation flights with an entry permit obtained from the Ministry of Foreign Affairs of Lao People's Dem. Rep.- This does not apply to emergency flights or technical stops where passengers and airline crew do not disembark.",
  },
  LB: {
    updated_at: "2020-04-12",
    description:
      " Flights to Lebanon are suspended.- This does not apply to:- diplomatic delegations working in Lebanon;- international organizations personnel;- military;- search and rescue, state aircraft and emergency medical flights; - United Nations Interim Force in Lebanon (UNIFIL) personnel associated with drilling operations in Block No. 4.",
  },
  LC: { updated_at: "2020-04-15", description: "Airports in St. Lucia are closed." },
  LI: {
    updated_at: "2020-04-14",
    description:
      '1. Passengers are not allowed to enter Switzerland.- This does not apply to nationals or residents of Switzerland or Liechtenstein.- This does not apply to passenger with a cross-border commuter permit who are entering Switzerland for work, with a C-visa issued by Switzerland for the purpose of "business meetings" as specialists in the field of health or "official visit" of great importance, with a D-visa issued by Switzerland or who have an assurance of a residence permit.-This does not apply to passengers traveling directly through Switzerland to another country that they are permitted to enter.- This does not apply to passengers who are entitled to freedom of movement and have a professional reason for entering Switzerland and have a confirmation of registration.- This does not apply to passengers who are of great importance as specialists in the health sector.- This does not apply to passengers travelling by land to their country of origin or residency within the European Union or Schengen area. They must have a proof of onward journey.2. Passengers can only land at Basel (BSL), Geneva (GVA) or Zurich (ZRH).',
  ...
  LU: {
    ...
    description:
      "Passengers are not allowed to enter Luxembourg.- This does not apply to nationals of Luxembourg and their family members in order to return home.- This does not apply to nationals of the European Union, Schengen Member States and the Schengen Associated States, passengers from the United Kingdom, and their family members in order to return home. - This does not apply to passengers who have a long-term resident status in accordance with the European Directive 2003/109/EC relating to long-term residents, as well as any other person who have a right of residence in accordance with European directives as well as national law in Grand Duchy of Luxembourg or one of the neighboring countries.- This does not apply to healthcare professionals, health researchers and healthcare professionals to the elderly.- This does not apply to cross-border workers.- This does not apply to members of the diplomatic corps, personnel of international organizations, the military, personnel of the development cooperation and humanitarian aid, during the exercise of their respective functions.- This does not apply to passenger travelling by land to their country of origin. They must have a proof of onward journey.- This does not apply to passengers traveling for urgent and duly justified family reasons.- This does not apply to passengers who want to apply for international protection or subsidiary protection in the Grand Duchy of Luxembourg or for other humanitarian reasons.",
  },
  LV: {
    updated_at: "2020-05-19",
    description:
      "1. Passengers are not allowed to enter and transit Latvia. - This does not apply to nationals and residents of Estonia, Latvia and Lithuania. 2. Passengers who have been in other countries than Estonia and Lithuania in the past 14 days must self-isolate at their place of residence for a period of 14 days.",
  },
  MA: { updated_at: "2020-03-30", description: " Flights to Morocco are suspended." },
  MC: {
    updated_at: "2020-05-06",
    description:
      '1. Passengers arriving from a non-Schengen Member State are not allowed to enter France.- This does not apply to:- nationals of France, their spouses and children;- nationals of an EEA Member State and Switzerland returning home, their spouses and children; - passengers with a residence permit issued by France, their spouses and children;- passengers with a residence permit issued by an EEA Member State, Switzerland or the United Kingdom returning home, their spouses and children;- healthcare professionals and researchers related to Coronavirus (COVID-19); - personnel of diplomatic and consular missions and international organizations headquartered or having an office in France; - cross-border workers.2. A completed International Travel Certificate must be presented prior to boarding and to Immigration upon arrival or when transiting France. The certificate must be obtained before departure via the French consular offices abroad or online at <a target="_blank" href="https://www.interieur.gouv.fr">https://www.interieur.gouv.fr</a>.',
  ...
  MD: {
    updated_at: "2020-03-16",
    description:
      " Passengers are not allowed to enter Moldova (Rep.). - This does not apply to nationals and residents of Moldova (Rep.).",
  },
  ME: {
    updated_at: "2020-03-15",
    description:
      " 1. Passengers are not allowed to enter Montenegro. - This does not apply to nationals of Montenegro. - This does not apply to passengers who reside in Montenegro. 2. Nationals and residents of Montenegro will be required to self-isolate for 14 days.",
  },
  MG: { updated_at: "2020-04-20", description: "All flights to Madagascar are suspended." },
  MH: { updated_at: "2020-04-03", description: " Passengers are not allowed to enter Marshall Isl." },
  MK: {
    updated_at: "2020-03-22",
    description:
      "North Macedonia (Rep.) borders are closed.- This does not apply to nationals and residents of North Macedonia (Rep.).- This does not apply to accredited diplomats.- This does not apply to passengers with a special permit issued by the Ministry of Interior of North Macedonia (Rep.).",
  },
  ML: {
    updated_at: "2020-05-04",
  ...
  MM: {
    updated_at: "2020-04-12",
    description:
      " 1. Visa issuance is suspended.2. Flights to Myanmar are suspended.- This does not apply to relief flights.- This does not apply to medical evacuation flights.- This does not apply to special flights approved by the Department of Civil Aviation.3. Airline crew are subject to quarantine.",
  },
  MN: {
    updated_at: "2020-05-06",
    description:
  ...
  NA: { updated_at: "2020-04-21", description: " Namibia's borders are closed." },
  NC: { updated_at: "2020-04-01", description: "Flights to New Caledonia are suspended." },
  NF: {
    updated_at: "2020-05-20",
    description:
      "1. Passengers are not allowed to enter Australia. - This does not apply to nationals of Australia. - This does not apply to the immediate family members of nationals of Australia. - This does not apply to permanent residents of Australia and their immediate family members. - This does not apply to nationals of New Zealand residing in Australia. - This does not apply to diplomats accredited to Australia and currently resident in Australia, and their immediate family members.2. Passengers and airline crew are required to self-isolate for a period of 14 days at their first arrival location in Australia. If their duration of stay is less than 14 days, they must self-isolate for the entire duration of stay.- This does not apply to airline crew with the appropriate personal protective equipment.3. Airline crew who are nationals or residents of Australia must self-isolate at their place of residence (or hotel) between flights, or for 14 days, whichever is shorter.Airline crew who are not nationals or residents of Australia must self-isolate in their hotel on arrival until their next flight.4. For repatriation charter flights, airlines are advised to contact the Australian Border Force (ABF) as early as possible in the planning process. Airlines should not confirm or schedule flights before discussing arrangements with the ABF repatriation team.5. Nationals of Fiji, Kiribati, Marshall Isl., Micronesia (Federated States), Nauru, New Zealand, Niue, Palau, Papua New Guinea, Samoa, Solomon Isl., Tonga, Tuvalu and Vanuatu with a confirmed onward ticket for a flight to a third country within 72 hours can transit without a visa. They must stay in the international transit area of the airport and have documents required for the next destination. 6. Passengers who reside in Cook Isl., French Polynesia or New Caledonia with a confirmed onward ticket for a flight to a third country within 72 hours can transit without a visa. They must stay in the international transit area of the airport and have documents required for the next destination. ",
  ...
  NI: {
    ...
    description:
      "Airports in Nicaragua are closed.- This does not apply to humanitarian flights with a flight authorization requested 72 hours prior to flight. The passenger manifest must be submitted with the request. ",
  },
  NL: {
    updated_at: "2020-05-12",
    description:
  ...
  NP: {
    updated_at: "2020-05-06",
    description:
      "1. International flights to Nepal are suspended.- This does not apply to evacuation, rescue and emergency flights with a special permission from Civil Aviation Authority of Nepal.2. Airline crew are subject to thermal screening.",
  },
  NR: {
  ...
  PE: {
    updated_at: "2020-04-14",
    description:
      "1. Passengers are not allowed to enter Peru.2. Airline crew must self-isolate at hotel Costa del Sol at Jorge Chavez International Airport for the entire duration of stay.",
  },
  PF: {
    updated_at: "2020-05-06",
    description:
  ...
  RE: {
    updated_at: "2020-05-06",
    description:
      '1. A completed International Travel Certificate must be presented prior to boarding and to Immigration upon arrival or when transiting Reunion. The certificate must be obtained before departure via the French consular offices abroad or online at <a target="_blank" href="https://www.interieur.gouv.fr">https://www.interieur.gouv.fr</a>.2. Passengers must go through a medical examination upon arrival and are subject to quarantine for a period of 14 days.- This does not apply to healthcare professionals related to Coronavirus (COVID-19).',
  },
  RO: {
    updated_at: "2020-05-18",
    description:
  ...
  RS: { updated_at: "2020-05-22", description: "No regulations related to Coronavirus (COVID-19) implemented." },
  RU: {
  ...
  RW: {
    updated_at: "2020-04-22",
    description:
      "1. Flights to Kigali International Airport (KGL) are suspended.2. Nationals and residents of Rwanda will be subject to a mandatory 14-day quarantine at designated locations.",
  },
  SA: {
    updated_at: "2020-05-19",
    description:
      "Flights to Saudi Arabia are suspended.- This does not apply to technical stops, humanitarian, medevac and repatriation flights. These flights are subject to prior approval from GACA. ",
  },
  SB: {
    updated_at: "2020-05-04",
    description:
  ...
  SC: {
    updated_at: "2020-05-06",
    description:
      "1. Seychelles (SEZ) is closed.- This does not apply to emergency diversions.- This does not apply to special mission flights that are approved (MEDEVAC).",
  },
  SD: {
    updated_at: "2020-04-20",
    description:
      "Airports in Sudan are closed. - This does not apply to technical stops, humanitarian aid, medical and relief flights. These flights are subject to prior approval from Sudan Civil Aviation Authority. ",
  },
  SE: {
    updated_at: "2020-05-18",
    description:
  ...
  SN: { updated_at: "2020-04-16", description: "Flights to Senegal are suspended." },
  SO: {
    updated_at: "2020-03-16",
    description:
      "Passengers arriving from China (People's Rep.), Iran, Italy or Korea (Rep.) are not allowed to enter Somalia.",
  },
  SR: { updated_at: "2020-04-09", description: "Airports in Suriname are closed." },
  SS: {
    updated_at: "2020-04-22",
    description:
      "Flights to South Sudan are suspended.- This does not apply to humanitarian and evacuation flights with an approval from the High Level Task Force of South Sudan.",
  },
  SV: {
    updated_at: "2020-04-17",
    description:
  ...
  SX: {
    updated_at: "2020-04-10",
    description:
      "Passengers and airline crew are not allowed to enter St. Maarten. - This does not apply to passengers who are specialists with evidence of traveling at the invitation of the Government of St. Maarten.- This does not apply to emergency and essential flights from Aruba, Curacao, Bonaire, St. Eustatius and Saba.",
  },
  SZ: {
    updated_at: "2020-04-24",
    description: "Passengers will be subject to self-isolation or mandatory 14-day quarantine in designated locations.",
  },
  TC: { updated_at: "2020-04-10", description: "Airports in Turks and Caicos Isl. are closed. " },
  TD: { updated_at: "2020-04-26", description: "Airports in Chad are closed." },
  TG: {
  ...
  TH: {
    updated_at: "2020-04-27",
    description:
      "Flights to Thailand are suspended.- This does not apply to state or military aircraft, emergency landing, technical landing without disembarkation, humanitarian aid, medical, relief and repatriation flights. Passengers are subject to quarantine for 14 days upon arrival. Airline crew must observe self-quarantine during their stay until the next flight schedule.",
  },
  TJ: {
    updated_at: "2020-03-19",
    description:
  ...
  TL: {
    updated_at: "2020-05-11",
    description:
      "1. Passengers are not allowed to enter Timor-Leste.- This does not apply to oil rig workers. 2 .Passengers are subject to health screening and to quarantine for 14 days.",
  },
  TM: {
    updated_at: "2020-04-17",
    description:
      "1. Flights to Turkmenistan are suspended.- This does not apply to repatriation flights of nationals and residents of Turkmenistan.2. Passengers are required to have a health report from the health organizations of the country they are arriving from. The report must show that they have undergone the Coronavirus (COVID-19) check and been tested negative.",
  },
  TN: {
    updated_at: "2020-05-04",
    description:
      "All flights to Tunisia are suspended.- This does not apply to:a. aircraft in a state of emergency;b. overflights;c. operations related to humanitarian aid, medical and relief flights;d. repatriation flights (only for nationals and permanent residents of Tunisia) - they will be placed in quarantine for 14 days;e. technical landings where passengers do not disembark;f. other safety-related operations.All the exceptions above are subject to prior request addressed to the Tunisian Civil Aviation Authority.",
  },
  TO: {
  ...
  TT: {
    updated_at: "2020-03-30",
    description:
      " Airports in Trinidad and Tobago are closed.- This does not apply if permitted by the Minister with responsibility for national security.",
  },
  TV: { updated_at: "2020-03-26", description: "Tuvalu's borders are closed." },
  TW: {
    updated_at: "2020-05-01",
    description:
  ...
  UZ: { updated_at: "2020-03-24", description: "Flights to Uzbekistan are suspended." },
  VA: {
    updated_at: "2020-05-20",
    description:
      "1. Passengers are not allowed to enter Italy.- This does not apply to:- nationals or residents of Italy;- passengers traveling on business;- passengers traveling for urgent health reasons;- healthcare personnel traveling on duty;- passengers traveling for emergency reasons;- passengers returning via Italy to their country of residence;- effective 3 June 2020, passengers arriving from Andorra, Austria, Belgium, Bulgaria, Croatia, Cyprus, Czechia, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Iceland, Ireland (Rep.), Latvia, Liechtenstein, Lithuania, Luxembourg, Malta, Monaco, Netherlands, Norway, Poland, Portugal, Romania, Slovakia, Slovenia, Spain, Sweden, Switzerland or United Kingdom.2. Passengers allowed to enter Italy must present a completed self-declaration form to the transporting carrier; and- must communicate their entry to the Department of Prevention at local health units (ASL) of the entrance district; and- are subject to health surveillance and isolation for 14 days. This does not apply to passengers traveling on business if their stay in Italy does not exceed 72 hours and if granted, the additional 48 hours of a justified extension for specific needs.",
  ...
  VG: { updated_at: "2020-04-17", description: "Airports are closed." },
  VI: {
    updated_at: "2020-05-01",
    description:
      "Passengers are not allowed to enter Virgin Isl. (USA).- This does not apply to residents of Virgin Isl. (USA), medical personnel, passengers traveling for business and property owners.",
  },
  VN: {
    updated_at: "2020-05-22",
    description:
